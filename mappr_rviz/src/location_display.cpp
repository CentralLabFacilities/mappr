...
{
  showLabel_ = new rviz::BoolProperty("show Label", true, "Draw the Label.", this, SLOT(slotShowLabel()));
}
...
void LocationDisplay::processMessage(const mappr_msgs::Location::ConstPtr& msg)
{
  if (!initialized)
  {
    firstMessage(msg);
